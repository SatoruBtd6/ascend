// Black Sun ring colour cycle evidence: same stage at ~2s and ~8s real time.
...
await page.screenshot({ path: join(OUT, "blacksun-ring-t2.png"), clip });
await new Promise(r => setTimeout(r, 5500));
await page.screenshot({ path: join(OUT, "blacksun-ring-t8.png"), clip });
await new Promise(r => setTimeout(r, 6000));
await page.screenshot({ path: join(OUT, "blacksun-ring-t14.png"), clip });
await browser.close();
console.log("done");
